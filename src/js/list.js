...
export function renderFormsCarousel(pokemonData) {
    const carousel = document.createElement('div');
    carousel.className = 'forms-carousel';

    const nonBattleForms = pokemonData.filter(form => !form.isBattleForm);
    ...
    nonBattleForms.forEach(form => {
        ...
        slide.innerHTML = `
            <img src="./sprites/icons/${form.formName.toLowerCase()}.png" alt="${form.displayName} sprite">
